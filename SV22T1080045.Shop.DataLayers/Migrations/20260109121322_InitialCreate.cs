        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BurningTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Customers",
                columns: new[] { "Id", "Address", "CreatedTime", "Email", "FullName", "IsDeleted", "PasswordHash", "PhoneNumber", "Role" },
                values: new object[] { 1, "Cửa hàng Hương Trầm", new DateTime(2026, 1, 9, 19, 13, 21, 406, DateTimeKind.Local).AddTicks(4480), null, "Quản trị viên", false, "123", "0909123456", "Admin" });
